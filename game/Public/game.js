...
function create() {
  ...
  this.add.image(200, 200, "scroll").setScale(0.3);

  cursors = this.input.keyboard.createCursorKeys();
  p1 = this.add.image(200, 350, "cake").setScale(0.5);

  var card1 = this.add.image(330, 400, "card").setScale(0.9);
  card1.setInteractive();
  card1.on("clicked", clickHandler, this);

  var card2 = this.add.image(230, 300, "card").setScale(0.9);
  card2.setInteractive();
  card2.on("clicked", clickHandler, this);

  var card3 = this.add.image(330, 100, "card").setScale(0.9);
